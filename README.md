...
- **代码目录结构**
  ...
  - **band_selction(特征波段选择方法)**
    ...
    - 结果：综合 K-Means聚类、RFE递归算法筛选结果及材料化学性质分析，最终选定4个关键波段：1140 nm、1200 nm、1245 nm和1310 nm。这些波段既保留了短波红外高光谱中塑料区分度最高的特征信息，又与多光谱滤光片设计兼容，为后续多光谱图像分类和工业化分选系统开发提供了可靠依据
    - figures文件下展示了经过数据预处理后的高光谱曲线图
